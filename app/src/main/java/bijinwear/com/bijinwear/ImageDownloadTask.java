        ...
        try
        {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK)
            {
                ...
                float times = 1.0f;/*
                                    ...
                                    * 画像が横長の場合 縦幅を横幅に合わせる times = 80.0f /
                                    * bitmap.getWidth(); }else
                                    * if(bitmap.getWidth() <
                                    * bitmap.getHeight()){//画像が縦長の場合、横幅を縦幅に合わせる
                                    * times = 80.0f / bitmap.getHeight(); }
                                    */

                return Bitmap.createScaledBitmap(bitmap, (int) (bitmap.getWidth() * times),
                        (int) (bitmap.getHeight() * times), true);
            }
